...
| 子 Agent / 并行 Agent | 已有 agent/team 工具、自定义 agent 发现和描述、工具集解析、runtime 准备、执行编排、运行记录持久化、team 并行执行、结果归集和子 Agent 用量汇聚 | `forgecc/core/subagent.py`, `forgecc/core/subagent_runtime.py`, `forgecc/instruments/agent.py`, `forgecc/instruments/team.py`, `tests/core/test_subagent.py`, `tests/core/test_subagent_discovery.py`, `tests/core/test_subagent_tools.py`, `tests/core/test_subagent_runtime_*.py` |
